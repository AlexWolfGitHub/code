    ...
    Calendar = (function () {
        ...
        Calendar.prototype.refreshCellClass = function (hasSelected) {
            ...
            injector.get("$timeout")(function () {
                ...
                self.datePane.find("[date-str]").removeAttr("today");
        ...
        Calendar.prototype.showCalendar = function ($element) {
            ...
            if (location.bottom > calendarHeight - document.documentElement.scrollTop) {
                this.element.css("top", location.top + this.parasitic[0].offsetHeight);
            } else {
                this.element.css("top", location.top - calendarHeight);
            }
            //this.element.css("top", location.top + this.parasitic[0].offsetHeight);
            this.calendarStyle = {
                "display": "block"
        ...
        Calendar.prototype.confirmHour = function ($event) {
            ...
            this.chooseDateCallBack.call(this, this.selectedDate, true);
        };
        ...
        Calendar.prototype.chooseDate = function () {
            ...
            if (angular.isDate(arg)) {
                ...
                this.selectedDate = arg;
                this.clearDirtyDateTime();
                this.chooseDateCallBack.call(this, this.selectedDate);
