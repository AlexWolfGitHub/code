define('framework/hotTable/HotTableModule', [
...
], function (angular, $, _, Handsontable, config) {
    ...
    return angular.module('HotTableModule', ['DataSourceModule', 'ColSettingsModule', 'GridLayoutModule', 'ng-context-menu', 'GroupDataSourceModule', 'ColGroupSettingsModule'])
        .directive('gHotTable', function ($dataSourceManager, $parse, $filter, $q, $compile, $timeout, ColSettings, gridLayoutService, LocalStorages, ColGroupSettings, GroupDataSources, ValidationHolder, AssociatePromiseService, Arrays, GillionMsg, ContextMenuService) {
            ...
            ColumnEditor.prototype._beginEditing = function (row, col) {
                ...
                if (!this.column || !this.column.columnEditorTmpl) {
                    if (this.column.tmpl && this.column.tmpl.indexOf('type="checkbox"') > 0) {
            ...
            HotTable.prototype.getSelectedIndex = function () {
                ...
                var handsontable = me.handsontable;
                var selected = handsontable.getSelected();
                var physicalRow = handsontable.toPhysicalRow(selected[0]);
                return physicalRow;
            };
            ...
            HotTable.prototype.autoWidthColumns = function () {
                var me = this;
                var plugin = me.handsontable.getPlugin('manualColumnResize');
                plugin.manualColumnWidths = [];
            ...
            HotTable.prototype.startEditNextCell = function () {
                ...
                nextColumn = _.find(columns, function (column) {
                    ...
                    if (after && (column.columnEditorTmpl || column.tmpl.indexOf('type="checkbox"') > 0)) {
                        return true;
                    }
                });
                    ...
                    .then(function () {
                        $timeout(function () {
                            ...
                            if (areChildrenCollapsed) {
                                ...
                                _.each(me.scope.physicalSourceInfo, function (info) {
                                    if (_.contains(info.parents, recordGroupInfo))
                ...
                function getCurrentValidatorFields() {
                    ...
                    _.forEach(recordInfo.invalidCells, function (fieldName) {
                        ...
                        var _rule = _.find(_validatorRules, function (r) {
                            ...
                            return r.ruleName === _ruleName && _.contains(r.properties, validatorName)
                                && _.contains(r.properties, _fieldName);
                        });
                        if (_rule) {
             ...
             * @param field 序号或字段
             */
            HotTable.prototype.select = function (physicalRow, field) {
                this.handsontable.selectCell(physicalRow, field);
            };
            ...
            HotTable.prototype._loadData = function (result, event) {
                ...
                if (scope.hasSummary && result['records'].length > 0) {
                    result['records'] = result['records'].concat([{__SUMMARY_ROW: true}]);
                }
                    ...
                    switch (node.tagName.toUpperCase()) {
                        ...
                        case 'G-HOT-COLUMN':
                            ...
                            if ($node.attr('type') === 'checkbox') {
                                ...
                                column.checkedTemplate = $node.attr('checked-template');
                                column.uncheckedTemplate = $node.attr('unchecked-template');
                            }
            ...
            HotTable.prototype._autoResizeWidth = function () {
                $(window).on('resize', _.throttle(this._autoWidth).bind(this));
            };
            ...
            HotTable.prototype._createSortFunc = function (sortNames, sortDirections) {
                ...
                return function (a, b) {
                    ...
                    for (var i = 0; i < len; i++) {
                        ...
                        va = a.record ? a.record[sortName] : a[sortName];
                        vb = b.record ? b.record[sortName] : b[sortName];
                        va = (!va && va !== 0) ? '' : va;
                        ...
                        if (va > vb) {
                            ret = sortDirection === ORDER.ASC ? 1 : -1;
                            break;
                        } else if (va < vb) {
                            ret = sortDirection === ORDER.ASC ? -1 : 1;
                            break;
            ...
            HotTable.prototype._beforeColumnMove = function (froms, target) {
                ...
                _.find(froms, function (from) {
                    ...
                    if (!column || column.field === '$$checked' || _.contains(groupFields, column.field)) {
            ...
            HotTable.prototype._appendChildren = function (parentIndex, children) {
                ...
                if (scope.hasCheckboxColumn) {
                    ...
                    if (parentRecord.$$checked) scope.checkedRows.concat(children);
                }
            ...
            HotTable.prototype._setModifiedRecordInfo = function (record, originalRecord, field) {
                ...
                if (!(
                        ...
                        ((angular.isDate(newValue) || angular.isDate(oldValue)) && compareDate(newValue, oldValue)) ||
            ...
            HotTable.prototype._toggleGroupChildrenChecked = function (record, checked, forceRender) {
                ...
                _.forEach(physicalSourceInfo, function (info) {
                    if (_.contains(info.parents, parentRecordInfo)) {
            ...
            HotTable.prototype._isAllGroupChildrenChecked = function (parentInfo) {
                ...
                var trimmedRecords = [];
                var nestedRowsPlugin = me.handsontable.getPlugin('nestedRows');
                var trimmedRows = nestedRowsPlugin ? nestedRowsPlugin.trimmedRows : [];
            ...
            HotTable.prototype._takeSnapshot = function () {
                ...
                var _top = me.element.parent().height() - me.element.height();
                me._elementClone = me.element.clone()
                    .removeClass('on-moving--columns')
                    .css({position: 'absolute', top: _top, left: 0, zIndex: 110});
            ...
            return {
                ...
                compile: function (tElement) {
                    return function (scope, element, attrs, controller) {
                        ...
                        scope.height = parseInt(attrs.height) || 500;
                        ...
                        _.each(hotTable.__originalCols, function (columnInfo, i) {
                            hotTable.__originalCols[i].renderer = function (instance, td, row, col, prop, value) {
                                ...
                                var $td, physicalRow, parsedValue, record, nodeId, recordGroupInfo;
                                physicalRow = instance.toPhysicalRow(row);
                                record = hotTable.getPhysicalRecord(physicalRow);
                                if (hotTable._isSummaryRow(record)) td.innerHTML = "";
                                if (!record || (hotTable._isSummaryRow(record) && !column.summary)) return td;
                                $td = $(td);
                                if (!record) {
                                ...
                                if (column && column.tmpl && (!hotTable._isSummaryRow(record) || (hotTable._isSummaryRow(record) && column.summary))) {
                                    /*var compileFunc = hotTable._getColumnTmplCompile(column);
                                    var $dom = compileFunc(hotTable._getCloneScope(physicalRow));
                                    $td.empty().append($dom);*/
                                ...
                                if (!hotTable._isSummaryRow(record)) {
                        ...
                        var hotSettings = {
                            ...
                            colHeaders: function (col) {
                                ...
                                if (prop === '$$checked') {
                                    ...
                                    columnHeader = '<span class="ht-column-title-text" ' + (column.headStyle ? 'style="' + column.headStyle + '"' : '') + '>' + column._title + '</span>';
                                    if (column._sortable) {
                            ...
                            afterFilter: function () {
                                ...
                                _.forEach(trimmedRows, function (row) {
                                    var filter = hotTable.handsontable.runHooks("isFilter", row);
                                    if (filter) {
                        ...
                        scope.hasSummary = _.some(hotTable.columns, function (column) {
                        ...
                        scope.$watchCollection("checkedRows", function (val) {
                            _.each(scope.source, function (record) {
                                record.$$checked = _.contains(val, record) ? true : false;
                            });
                            hotTable._updateIsAllChecked();
                        });
                        ...
                        hotTable.handsontable.addHook('afterChange', function (changes) {
                            ...
                            _.forEach(changes, function (change) {
                                if (change[1] === '$$checked' && change[2] != change[3]) {
                                    ...
                                    if (checked) {
                                        scope.checkedRows = scope.checkedRows.concat(record);
                                    } else {
                        ...
                        hotTable.handsontable.addHook('beforeOnCellMouseDown', function (event, coords) {
                            ...
                            if (event.button === 2) {
                                ...
                                scope.__willFixedColumnsCount = count;
                                return;
                            }
                        ...
                        hotTable.handsontable.addHook('afterSelectionEnd', function (row, col) {
                            var physicalRow = hotTable.handsontable.toPhysicalRow(row);
