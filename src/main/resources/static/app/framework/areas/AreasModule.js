        ...
        .directive('gAreas', ['$compile', 'AreaService', 'Arrays', '$window', '$document', '$timeout', '$http', '$tabindex', 'GillionMsgService', 'Locations',
            ...
            Areas.prototype = {
                ...
                selectSearching: function (event) {
                    var me = this,
                        scope = me.scope,
                        selected = me.foundAreas[me.selectedIndex],
                ...
                nav: function (event) {
                    var me = this;
                    if (me.__showPanel === true && me.searching === true && me.foundAreas && me.foundAreas.length > 0) {
            ...
            function canAreaCodeRender(scope, areaCode) {
                ...
                var cities = AreaService.getAreaChildren(areaCode, groupName);
                return canGroupRender(scope, groupName) || isSpecialArea(cities);
            }
                ...
                link: function (scope, element, attrs, ngModelController) {
                    ...
                    element.on('blur', function () {
                        ...
                        if (ngModelController && areas.getDisplay(ngModelController.$viewValue) !== element.val()) {
                            scope.selectedArea = scope.$selectedArea = undefined;
                            areas.selectedIndex = undefined;
