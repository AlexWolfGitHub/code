        ...
        return angular.module('ColSettingsModule', [])
            .directive('gColSettings', function ($parse, $rootScope, $window, GillionMsg, GillionLocationService, Arrays, gridLayoutService) {
                ...
                ColSettingsProto.enter = function () {
                    ...
                    me.__currentGrid._enterCols(enteredCols, null, me.getFixedColumns());
                    me.hide();
                };
                ...
                ColSettingsProto._getUnSelected = function () {
                    var me = this,
                        ...
                        source = me.source;
                    return _.partial(_.without, source).apply(null, selected);
                };
                ...
                ColSettingsProto._deselect = function () {
                    ...
                    if (l.length == 0) {
                        GillionMsg.alert(null, ($config.i18nInfo.layoutSelectItem ? $config.i18nInfo.layoutSelectItem : '请选择选项!'));
                        return;
                    }
