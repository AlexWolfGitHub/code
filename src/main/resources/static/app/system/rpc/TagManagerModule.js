define([
    ...
    return angular.module('TagManagerModule', ['ColSettingsModule', 'DataGridModule', 'GillionPaginationModule', 'GillionDictModule', 'GillionDropdownModule', 'GillionNumberSpinnerModule', 'GillionAssociateModule', 'GillionTabModule', 'PrintSettingsModule'])
        .controller('TagManagerController', function ($scope, $http, $log, Arrays, $compile, $q) {
            $scope.add = function () {
                $("#testModal").modal();
            }
