define([
    ...
    return angular.module('HttpAuthenticationStrategyManagerModule', ['ColSettingsModule', 'DataGridModule', 'GillionPaginationModule', 'GillionDictModule', 'GillionDropdownModule', 'GillionNumberSpinnerModule', 'GillionAssociateModule', 'GillionTabModule', 'PrintSettingsModule'])
        .controller('HttpAuthenticationStrategyManagerController', function ($scope, $http, $log, Arrays, $compile, $q) {
            $scope.add = function () {
                $("#testModal").modal();
            }
