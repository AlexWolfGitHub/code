define([
    ...
    return angular.module('ProviderNodeManagerModule', ['ColSettingsModule', 'DataGridModule', 'GillionPaginationModule', 'GillionDictModule', 'GillionDropdownModule', 'GillionNumberSpinnerModule', 'GillionAssociateModule', 'GillionTabModule', 'PrintSettingsModule'])
        .controller('ProviderNodeManagerController', function ($scope, $http, $log, Arrays, $compile, $q) {
