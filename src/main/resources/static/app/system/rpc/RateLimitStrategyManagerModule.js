define([
    ...
    return angular.module('RateLimitStrategyManagerModule', ['ColSettingsModule', 'DataGridModule', 'GillionPaginationModule', 'GillionDictModule', 'GillionDropdownModule', 'GillionNumberSpinnerModule', 'GillionAssociateModule', 'GillionTabModule', 'PrintSettingsModule'])
        .controller('RateLimitStrategyManagerController', function ($scope, $http, $log, Arrays, $compile, $q) {
            $scope.add = function () {
                $("#testModal").modal();
            }
            $scope.edit = function () {
