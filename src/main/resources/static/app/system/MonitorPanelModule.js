define([
    ...
    return angular.module('MonitorPanelModule', ['ColSettingsModule', 'DataGridModule', 'GillionPaginationModule', 'GillionDictModule', 'GillionDropdownModule', 'GillionNumberSpinnerModule', 'GillionAssociateModule', 'GillionTabModule', 'PrintSettingsModule','DateModule'])
        .controller('MonitorPanelController', function ($scope, $http, $log, Arrays, $compile, $q) {
